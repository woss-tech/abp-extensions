...
namespace Woss.Abp.EntityFrameworkCore.Extensions.EntityFrameworkCore.Modeling;
...
public static class AbpEntityTypeBuilderExtensions
{
    ...
    {
        if (!b.Metadata.ClrType.IsAssignableTo<IHasExtraProperties>()) return;
    ...
    {
        if (b.Metadata.ClrType.IsAssignableTo<IHasExtraProperties>()) ObjectExtensionManager.Instance.ConfigureEfCoreEntity(b);
    }

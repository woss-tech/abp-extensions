...
namespace Volo.Abp.Shared.Hosting.Microservices.EfCore;

public abstract class PendingEfCoreMigrationsChecker<TDbContext> : PendingMigrationsCheckerBase where TDbContext : DbContext
{

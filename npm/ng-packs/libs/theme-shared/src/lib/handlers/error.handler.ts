...
export class ErrorHandler {
  ...
  constructor(protected injector: Injector) {
    ...
    this.confirmationService = injector.get(NzModalService);
  ...
  protected showError(
    ...
    return this.confirmationService.confirm({
      nzTitle: title.toString(),
      nzContent: message.toString(),
    });
  ...
  createErrorComponent(instance: Partial<HttpErrorWrapperComponent>) {
    ...
    for (const key in instance) {
      ...
      if (
        Object.prototype.hasOwnProperty.call(this.componentRef.instance, key)
      ) {
